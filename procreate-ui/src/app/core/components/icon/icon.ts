...
/**
 * Inline SVG icon set (feather-style, 24x24, currentColor stroke).
 * Standalone so it can be imported by both CoreModule and lazy feature modules.
 * Usage: <app-icon name="bell" [size]="20"></app-icon>
 */
@Component({
  selector: 'app-icon',
  standalone: true,
...
export class IconComponent {
  ...
  set name(value: string) {
    this._name = value;
    const path = IconComponent.ICONS[value] ?? '';
  ...
  private static readonly ICONS: Record<string, string> = {
    cashier: '<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M2 11h20"/><circle cx="12" cy="16" r="2"/>',
    orders: '<path d="M9 2h6a1 1 0 0 1 1 1v1h1a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h1V3a1 1 0 0 1 1-1Z"/><path d="M9 4h6"/><path d="M9 11h6"/><path d="M9 15h4"/>',
    ...
    results: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6"/><path d="M8 13h8"/><path d="M8 17h5"/>',
    ...
    qr: '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3"/><path d="M21 14v.01"/><path d="M14 21h.01"/><path d="M21 21v-4"/><path d="M17 21h.01"/>',
    ...
    headset: '<path d="M3 14v-3a9 9 0 0 1 18 0v3"/><path d="M21 16a2 2 0 0 1-2 2h-1a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1h3Z"/><path d="M3 16a2 2 0 0 0 2 2h1a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1H3Z"/>',
    ...
    key: '<circle cx="7.5" cy="15.5" r="4.5"/><path d="m10.7 12.3 8.8-8.8"/><path d="m17 5 3 3"/><path d="m14 8 3 3"/>',
